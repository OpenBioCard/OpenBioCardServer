...
> Note: The API and data structures of **OpenBioCard Server NEXT** are almost entirely incompatible with the original design/implementation.  
> For compatibility, please switch to the Master branch.
